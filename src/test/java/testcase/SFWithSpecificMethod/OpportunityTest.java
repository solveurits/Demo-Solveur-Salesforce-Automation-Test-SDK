package testcase.SFWithSpecificMethod;
...
//      driver.get("http://login.Salesforce.com/");
    ...
    public void Opportunity() throws FilloException {
    	...
    	opportunity.createOpportunityAndVerifyWithSpecificMethod(driver, dataOpportunity, timeoutSeconds);
    }
    ...
    public void addActivity() throws FilloException
    {
    	...
    	activity.addNewTaskActivityWithSpecificMethod(driver, dataActivity, timeoutSeconds);
    	//Add New Log A Call Activity
    	activity.addLogACallActivityWithSpecificMethod(driver, dataActivity, timeoutSeconds);
